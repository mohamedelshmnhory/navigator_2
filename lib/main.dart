  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: MaterialApp.router(
        ...
        routerDelegate:
            _appRouter.delegate(navigatorObservers: () => [MyObserver()]),
...
// adb shell
// am start -W -a android.intent.action.VIEW -c android.intent.category.BROWSABLE -d "http://mg.com/layout/categories/CourseDetailsScreen/14"